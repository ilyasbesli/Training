 ...
 * Constraints
 * 
 * Each line contains a maximum of printable characters. The total number of
 * characters in all test cases will not exceed . Output Format
 * 
 ...
 * Sample Output
 * 
 * Nayeem loves counseling Sanjay has no watch So wait for a while None Imtiaz
 * has a secret crush
 * 
 * @author ibesli
 *
